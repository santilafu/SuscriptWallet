# Política de Privacidad de SuscriptWallet
...
* **Datos de cuenta:** Usuario y contraseña (almacenada de forma segura) para la autenticación.
* **Datos de suscripciones:** Nombres de los servicios, precios, fechas de renovación y notas que decidas añadir en la app.

## 3. Finalidad del tratamiento
Utilizamos tus datos **exclusivamente** para proporcionarte el servicio de gestión de suscripciones y sincronizar tu información. En ningún caso venderemos tus datos ni crearemos perfiles publicitarios con ellos.
